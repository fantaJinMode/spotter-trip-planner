...
export const fixtureTrip: TripPlan = {
  ...
  logs: [
    { date: "2026-07-14", events: [
        ...
        { status: "off_duty", start: "21:15", end: "24:00", note: "10 hr rest" },
      ],
      totals: { off_duty: 11.25, sleeper: 0, driving: 11, on_duty: 1 } },
    { date: "2026-07-15", events: [
        { status: "off_duty", start: "00:00", end: "07:15", note: "rest cont." },
      ...
      totals: { off_duty: 13.5, sleeper: 0, driving: 9, on_duty: 1.5 } },
  ],
};
